...
servo1_rad = math.radians(servo1_deg) #diubah ke radians karena python pake radian buat trigo
servo2_rad = math.radians(servo2_deg)

x1 = femur * math.cos(servo1_rad) #masukin rumus
y1 = femur * math.sin(servo1_rad)

x2 = x1 + tibia * math.cos(servo1_rad + servo2_rad) #masukin rumus
